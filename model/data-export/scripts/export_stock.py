"""Extract a scoped dwelling stock from households.db (SQLite, 9.7M rows NL-wide) -- any
province, municipality or the whole country (--scope) -- and compute per-dwelling heat demand using the model's VestaMAIS archetype method
...
Output: model/data/stock/<scope>_dwellings.csv  (one row per dwelling).
